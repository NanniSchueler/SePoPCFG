                ...
                for word in word_list:
                    ...
                    if second_call == False:
                        ...
                        if new_words_model:
                            ...
                            #print(len(new_words_model))
                            new_words_model.insert(0,[(word,1)])
                            for index, neighbourhood in enumerate(new_words_model):
                                for item in neighbourhood:
                                    if isinstance(item[0],str):
                                        if index != 0:
                                            help_list.append(item[0])
                                        
                                    else:
                                        if index != 0:
                                            help_list.append(item[1])
