...
def run_trainer(program_info, base_directory):
        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    #das gecashte model zu laden. Bisher trat das Problem nur bei Fasttext modellen auf. Diese 
    ...
    pcfg_parser = PCFGPasswordParser(multiword_detector,program_info)
    ...
    try:
        ...
        while password:
            ...
            # Parse the pcfg info
            pcfg_parser.parse(password,model_list, program_info)
